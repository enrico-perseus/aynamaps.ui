...
@Component({
  ...
  templateUrl: '../edit-facilities/edit-facilities.component.html',
...
export class AddFacilitiesComponent implements OnInit {
    ...
    reset() {
        ...
        self.facilityData.building_id = self.route.snapshot.params['building_id'];
        console.log("building_id===========" + self.facilityData.building_id);
        self.facilityData.floor_id = self.route.snapshot.params['floor_id'];
        console.log("floor_id===========" + self.facilityData.floor_id);            
        self.getFloors();
        self.getLanguages();
        });
    }
    ...
    save(){
        ...
        if (this.facilityData.facility_name.length > 0 && this.facilityData.latitude > 0 && this.facilityData.longitude > 0){
            this.uploadFiles();
        } else if (this.facilityData.facility_name.length == 0) {
            this.toastrService.error("The facility name is required", 'Error!!', {"positionClass": "toast-bottom-right"});
        } else {
            this.toastrService.error("The facility map position is required", 'Error!!', {"positionClass": "toast-bottom-right"});
        }
    }
    ...
    saveFacilityData() {
        ...
        this.customerService.createFacility(this.facilityData).then(
            res => {                
            ...
            err => {
                ...
                if (err._body != undefined && err._body != null) {
                    ...
                    self.toastrService.error("Failed to create Facility.", 'Error!!', {"positionClass": "toast-bottom-right"});
                }
            }
        )
    }
