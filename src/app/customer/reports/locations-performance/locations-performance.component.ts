...
@Component({
  selector: 'app-locations-performance',
  templateUrl: './locations-performance.component.html',
  styleUrls: ['./locations-performance.component.css']
})
export class LocationsPerformanceComponent implements OnInit {
